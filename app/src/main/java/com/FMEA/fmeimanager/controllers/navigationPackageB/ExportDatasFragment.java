...
import com.FMEA.fmeimanager.controllers.navigationPackageB.adapters.FmeiExportAdapter;
...
import com.FMEA.fmeimanager.utils.StorageUtils;
...
public class ExportDatasFragment extends Fragment implements ExportViewPagerFragment.ExportViewPagerListener {
    ...
    private void senEmail(String body, String fmeaName){
        ...
        intent.putExtra(Intent.EXTRA_STREAM, FileProvider.getUriForFile(getContext(),"com.FMEA.fmeimanager", newFile));
