...
public class HelpFragment extends Fragment {
    ...
    public interface HelpListener{
        void updateHelpNavHeader(Participant participant);
    }
    ...
    public void onAttach(Context context) {
        ...
        try {
            mCallback = (HelpListener) getActivity();
    ...
    private void updateAdministrator(Participant participant){
        Toast.makeText(getContext(), participant.getForname() + " " + participant.getName() + "/HelpActivity", Toast.LENGTH_SHORT).show();
        mCallback.updateHelpNavHeader(participant);
    }
