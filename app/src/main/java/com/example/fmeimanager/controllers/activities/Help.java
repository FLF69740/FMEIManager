...
import com.example.fmeimanager.controllers.fragments.HelpFragment;
...
public class Help extends BaseActivity {
    ...
    private void updateAdministrator(Participant participant){
        Toast.makeText(this, participant.getForname() + " " + participant.getName() + "/Help", Toast.LENGTH_SHORT).show();
